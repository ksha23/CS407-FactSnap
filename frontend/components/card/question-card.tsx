...
import { Avatar, Card, XStack, YStack, Text, Button, H3, Label, View } from "tamagui";
            ...
            <YStack gap={isDetails ? "$3" : "$2"}>
                ...
                {question.content.type !== ContentType.NONE &&
                    (isDetails ? (
                        ...
                        <Text fontWeight={600} fontStyle="italic">
                            This question contains a {question.content.type.toLowerCase()}
                        </Text>
                    ))}
                ...
                {isDetails ? (
                    <>
                        ...
                        {/* Creation + Edited Date */}
                        <XStack gap="$1" flexWrap="wrap">
                            <Text color="$gray10">
                                {multiFormatDateString(question.created_at)}
                            </Text>
                            {question.edited_at &&
                                question.created_at !== question.edited_at && (
                                    <Text color="$gray10">
                                        (edited{" "}
                                        {multiFormatDateString(
                                            question.edited_at,
